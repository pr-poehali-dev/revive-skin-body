  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1519823551278-64ac92734fb1?q=80&w=2748&auto=format&fit=crop")',
        }}
      >
        ...
        <div className="max-w-2xl">
          <div className="fade-in-animation">
            ...
            <h1 className="text-white font-playfair font-medium text-5xl md:text-6xl leading-tight mb-6">
              Ваше тело заслуживает{" "}
              <span className="text-revive-primary">возрождения</span>
            </h1>

            <p className="text-revive-sand/90 text-lg mb-8 max-w-md">
              Профессиональный массаж и СПА-процедуры для тех, кто ценит
              качество и индивидуальный подход.
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="btn-primary">Записаться онлайн</Button>
              <Button
                variant="outline"
