// Заменяем импорт framer-motion на обычные CSS-анимации
    ...
    <section className="py-20 bg-revive-light dark:bg-revive-dark/70">
      <div className="container-revive">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Фото */}
          <div className="fade-in-animation relative">
            ...
            <div className="absolute top-6 -left-6 bg-white dark:bg-revive-dark shadow-lg p-4 rounded-lg z-20 flex items-center">
              ...
              <div>
                <p className="text-sm text-gray-500 dark:text-revive-sand/70">
                  Опыт работы
                </p>
          ...
          <div className="fade-in-animation">
            ...
            <p className="mb-6 text-gray-600 dark:text-revive-sand/80">
              REVIVE Skin & Body Studio — это пространство, где ваше тело и кожа
              получают профессиональный уход. Основатель студии, Константинова
              Полина Ивановна, с 2015 года создает индивидуальные программы для
              восстановления и релакса.
            </p>

            <p className="mb-8 text-gray-600 dark:text-revive-sand/80">
              Мы используем только сертифицированные средства и авторские
              методики, разработанные на основе многолетнего опыта и постоянного
            ...
            <ul className="space-y-3 mb-8">
              {benefits.map((benefit, index) => (
                <li
                  key={index}
                  className="flex items-start gap-3 fade-in-animation"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <CheckCircle
                    size={20}
                    className="text-revive-primary mt-1 shrink-0"
                  />
                  <span className="text-gray-700 dark:text-revive-sand/90">
                    {benefit}
                  </span>
                </li>
              ))}
            ...
            <blockquote className="border-l-4 border-revive-primary pl-4 italic text-gray-600 dark:text-revive-sand/80">
              "Здоровье и красота — это гармония души и тела. Моя миссия —
              помочь вам достичь этой гармонии через профессиональный уход и
              заботу."
