        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="max-w-2xl mx-auto text-gray-600 dark:text-revive-sand/80">
              Запишитесь на процедуру или задайте интересующий вас вопрос. 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div className="bg-revive-light dark:bg-revive-dark/30 p-8 rounded-lg border border-revive-sand/20">
              <h3 className="font-playfair text-2xl mb-6 dark:text-white">Контактная информация</h3>
              ...
              <ul className="space-y-6">
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-revive-sand/80">г. Саратов, ул. Примерная, д. 123</p>
                  </div>
                </li>
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-medium mb-1 dark:text-white">Телефон</h4>
                    <p className="text-gray-600 dark:text-revive-sand/80">
                      <a href="tel:+71234567890" className="hover:text-revive-primary transition-colors">
                        +7 (123) 456-78-90
                      </a>
                    </p>
                  </div>
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-revive-sand/80">
                      <a href="mailto:info@revive-studio.ru" className="hover:text-revive-primary transition-colors">
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-medium mb-1 dark:text-white">Часы работы</h4>
                    <p className="text-gray-600 dark:text-revive-sand/80">Пн-Пт: 9:00 - 20:00</p>
                    <p className="text-gray-600 dark:text-revive-sand/80">Сб-Вс: 10:00 - 18:00</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.7 }}
          >
            <form onSubmit={handleSubmit} className="bg-white dark:bg-revive-dark/30 p-8 rounded-lg border border-revive-sand/20">
              <h3 className="font-playfair text-2xl mb-6 dark:text-white">Обратная связь</h3>
              
              <div className="space-y-4">
                <div>
                  <label htmlFor="name" className="block mb-2 text-gray-700 dark:text-revive-sand/90">
                    Ваше имя *
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="phone" className="block mb-2 text-gray-700 dark:text-revive-sand/90">
                    Телефон *
                  </label>
                  <input
                    type="tel"
                ...
                <div>
                  <label htmlFor="email" className="block mb-2 text-gray-700 dark:text-revive-sand/90">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="message" className="block mb-2 text-gray-700 dark:text-revive-sand/90">
                    Сообщение
                  </label>
                  <textarea
                    id="message"
